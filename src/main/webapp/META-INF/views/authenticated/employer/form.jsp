...
<acme:form>
	<acme:form-textbox code="authenticated.employer.form.label.companyName" path="companyName"/>
	<acme:form-textbox code="authenticated.employer.form.label.activitySector" path="activitySector"/>
